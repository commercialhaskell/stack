...
<https://www.stackage.org/lts-23.17>, you will see a list of 3,212 packages at
specific version numbers. When you then specify `snapshot: lts-23.17` or,
alternatively, `resolver: lts-23.17`, you're telling Stack to use those package
