...
<https://www.stackage.org/lts-24.6>, you will see a list of 3,407 packages at
specific version numbers. When you then specify `snapshot: lts-24.6` or,
alternatively, `resolver: lts-24.6`, you are telling Stack to use those package
