...
<https://www.stackage.org/lts-23.8>, you will see a list of 3,198 packages at
specific version numbers. When you then specify `snapshot: lts-23.8` or,
alternatively, `resolver: lts-23.8`, you're telling Stack to use those package
