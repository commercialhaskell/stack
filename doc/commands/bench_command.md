...
~~~text
stack bench [TARGET] [--dry-run] [--pedantic] [--fast] [--ghc-options OPTIONS]
            ...
            [--[no-]info-table-profiling] [--[no-]haddock]
...
see the documentation for the [`stack build`](build_command.md) command.
