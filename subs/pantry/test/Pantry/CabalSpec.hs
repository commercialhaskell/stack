...
spec = describe "wrong cabal file" $ do
  ...
  test "Hackage" $ do
    let pli =
        ...
        Right sha = mkStaticSHA256FromText "71c2c685a932cd3a70ec52d7bd0ec96ecbfa5e31e22130099cd50fa073ad1a69"
        size = FileSize 597
    go `shouldThrow'` \e ->
      case e of
        ...
        archive =
            Archive
              ...
              , archiveHash = either impureThrow Just
                            $ mkStaticSHA256FromText "b5a582209c50e4a61e4b6c0fb91a6a7d65177a881225438b0144719bc3682c3a"
    ...
    go `shouldThrow'` \e ->
      case e of
        MismatchedPackageMetadata pli' pm' cabal ident ->
          ...
          pm == pm' &&
          cabal == BlobKey
            (either impureThrow id $ mkStaticSHA256FromText "940d82426ad1db0fcc978c0f386ac5d06df019546071993cb7c6633f1ad17d50")
            (FileSize 3038) &&
