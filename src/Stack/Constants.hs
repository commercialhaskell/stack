 ...
 where
  mparsed = mapM parsePackageName
    [ "ghc-prim"
      -- A magic package
    , "integer-gmp"
      -- No longer magic > 1.0.3.0. With GHC 9.4.8 at least, there seems to be
    ...
    , "dph-seq"
      ...
      -- magic. With GHC 9.4.8 at least, there seems to be no problem in using
      -- it.
    , "dph-par"
    ...
    , "ghc"
      -- A magic package
    , "interactive"
      -- Could not identify information about this package name. With GHC 9.4.8
