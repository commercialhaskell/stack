...
-- | Convert a 'ComponentKey' to a value of a string-like type.
fromComponentKey :: IsString a => ComponentKey -> a
fromComponentKey (ComponentKey pkgName component) =
  fromString $ T.unpack $ renderPkgComponent (pkgName, component)
