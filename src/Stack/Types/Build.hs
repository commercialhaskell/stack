...
configureOptsNoDir econfig bco deps isLocal package = concat
    ...
    , maybe [] (\customProgJhcPath             -> ["--with-jhc="               ++ toFilePath customProgJhcPath             ]) (configProgJhcPath             config)
    , maybe [] (\customProgLdPath              -> ["--with-ld="                ++ toFilePath customProgLdPath              ]) (configProgLdPath              config)
    , maybe [] (\customProgLhcPath             -> ["--with-lhc="               ++ toFilePath customProgLhcPath             ]) (configProgLhcPath             config)
    , maybe [] (\customProgLhcPkgPath          -> ["--with-lhc-pkg="           ++ toFilePath customProgLhcPkgPath          ]) (configProgLhcPkgPath          config)
    ...
    , maybe [] (\customProgUhcPath             -> ["--with-uhc="               ++ toFilePath customProgUhcPath             ]) (configProgUhcPath             config)
    ...
    , map (("--jhc-option="               ++) . T.unpack) (configProgJhcOptions             config)
    , map (("--ld-option="                ++) . T.unpack) (configProgLdOptions              config)
    , map (("--lhc-option="               ++) . T.unpack) (configProgLhcOptions             config)
    , map (("--lhc-pkg-option="           ++) . T.unpack) (configProgLhcPkgOptions          config)
    ...
    , map (("--uhc-option="               ++) . T.unpack) (configProgUhcOptions             config)
    , ["--ghcjs" | wc == Ghcjs]
